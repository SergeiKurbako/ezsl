(function(){
    ...
    preload.preload = function() {
    	...
    	game.load.image('raise_bet', needUrlPath + '/img/btns/RAISE_BET.png');
    	game.load.image('raise_bet_p', needUrlPath + '/img/btns/RAISE_BET_p.png');
    	game.load.image('keep_bet', needUrlPath + '/img/btns/KEEP_BET.png');
    	game.load.image('keep_bet_p', needUrlPath + '/img/btns/KEEP_BET_p.png');
        ...
        game.load.image('dol22', needUrlPath + '/img/dol22.png');
        ...
        game.load.image('choose_double', needUrlPath + '/img/CHOOSE_DOUBLE.png');

        game.load.image('yellow_btn', needUrlPath + '/img/yellow_btn/btn.png');
        game.load.image('green_btn', needUrlPath + '/img/green_btn/btn.png');

        game.load.image('red_bg_1', needUrlPath + '/img/red_bg_1.png');
        game.load.image('red_bg_2', needUrlPath + '/img/red_bg_2.png');
        game.load.image('red_bg_3', needUrlPath + '/img/red_bg_3.png');
        game.load.image('red_bg_4', needUrlPath + '/img/red_bg_4.png');
        game.load.image('red_bg_5', needUrlPath + '/img/red_bg_5.png');
        game.load.image('red_bg_6', needUrlPath + '/img/red_bg_6.png');
        game.load.image('red_bg_7', needUrlPath + '/img/red_bg_7.png');
        for (var i = 1; i <= 80; ++i) {
      ...
      game.load.audio('half_sound', needUrlPath + '/sounds/Z_02_Cub.mp3');
      for (var i = 1; i <= 10; ++i) {
      ...
      game.load.spritesheet('sorry_anim', needUrlPath + '/img/sorry_anim.png', 465, 69, 5);
        ...
        game.load.spritesheet('btn_border_anim', needUrlPath + '/img/btn_border_anim.png', 103, 73, 3);
    };
